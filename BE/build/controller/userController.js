...
function getBase64ImageSize(base64String) {
  ...
  var base64WithoutPrefix = base64String.replace(/^data:image\/(png|jpg|jpeg);base64,/, "");

  // Calculate the size
  var sizeInBytes = base64WithoutPrefix.length * 3 / 4;
  return sizeInBytes;
}
  ...
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          size = getBase64ImageSize(req.body.avatar);
          console.log(size);
          _context3.next = 4;
  ...
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 5:
          data = _context6.sent;
          return _context6.abrupt("return", res.status(200).json(_objectSpread({}, data)));
        case 9:
