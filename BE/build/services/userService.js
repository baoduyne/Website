...
var createNewUser = function createNewUser(data) {
  return new Promise(/*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(resolve, reject) {
      var check, hashPasswordFromBcrypt, avatarBuffer;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 10:
            ...
            avatarBuffer = data.avatar instanceof Buffer ? data.avatar : Buffer.from(data.avatar, 'base64');
            _context5.next = 14;
...
var getAllCodeService = function getAllCodeService(type) {
  return new Promise(/*#__PURE__*/function () {
