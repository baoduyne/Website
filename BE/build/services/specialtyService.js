    ...
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            if (!(!data.nameSpecialty || !data.contentMarkdown || !data.descriptionHTML || !data.avatar)) {
              _context.next = 5;
              break;
            }
            resolve({
...
var getDetailSpecialty = function getDetailSpecialty(specialtyId, provinceId, type) {
  return new Promise(/*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
      var data, doctorData, arrDoctorId, _doctorData, _arrDoctorId, _doctorData2, _arrDoctorId2;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 11:
            data.specialtyData = _context3.sent;
            _context3.next = 38;
            break;
          case 14:
            if (!(provinceId === 'ALL')) {
          ...
          case 26:
            _doctorData = _context3.sent;
            _arrDoctorId = [];
            _doctorData.map(function (item) {
              _arrDoctorId.push(item.doctorId);
            });
            data.doctorData = _arrDoctorId;
          case 30:
            _context3.next = 38;
            break;
          case 32:
          ...
          case 34:
            _doctorData2 = _context3.sent;
            _arrDoctorId2 = [];
            _doctorData2.map(function (item) {
              _arrDoctorId2.push(item.doctorId);
            });
            data.doctorData = _arrDoctorId2;
          case 38:
            if (data) {
              resolve({
                errCode: 0,
