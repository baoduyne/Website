    ...
    render() {
        ...
        return (
            ...
            <div className='section-container section-home-footer'>
                <div className='footer-description'>This website was developed by Bao Duy with purposes acquire knownledge and improve development skills </div>
                ...
                <div className='footer-social-link'>
                    ...
                    <a href='https://github.com/vitmetmoi' className='social-icon' target='blank_'><i class="fab fa-github social-icon"></i></a>
